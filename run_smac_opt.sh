...
CONFIG_PATH="/work/pi_kandread_umass_edu/tss-ml/runs/ssf_smac_opt/small_search.yml"

# Run the Python script with the provided task_id as the grid search index
python $SCRIPT_PATH --smac_optimize $CONFIG_PATH --smac_runs 300 --smac_workers 50
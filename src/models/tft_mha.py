...
class HybridEncoder(eqx.Module):
    ...
    def __call__(self, dynamic_in: dict, static, key):
        ...
        flat_weights = jax.vmap(self.weights_grn, in_axes=(0, None, 0))(flattened, static, weight_keys)
...
class EnrichedDecoder(eqx.Module):
    ...
    def __call__(self, encoded, static, key):
        ...
        enriched = jax.vmap(self.enrichment_grn, in_axes=(0, None, 0))(encoded, static, enrich_keys)
        ...
        decoder_out = jax.vmap(self.feed_forward, in_axes=(0, None, 0))(attn_skip, None,
                                                                        jrandom.split(keys[3], seq_length))
